...
export function auth(email, password, isLogin) {
    return async dispatch => {
        ...
        // const response = await axios.post('https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=rlQksZYBG9sOs5HKI+XLbap+g1f15C3OuA8eZb9uX3/7PgPz92H3HYypUOY3ZSIXJzLRaIDYVwf7wBFJZiHBeA==', authData)
